public class TemperatureUnitConvertor {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Pounds to Kilograms : " + convertPoundsToKilograms(100));
        System.out.println("Kilograms to Pounds : " + convertKilogramsToPounds(45.5));
        System.out.println("Gallons to Liters : " + convertGallonsToLiters(2));
        System.out.println("Liters to Gallons : " + convertLitersToGallons(7.5));
    }
}
